const security_rules = `You are a security analysis expert with extensive experience in application security, penetration testing, OWASP Top 10, secure coding practices, and vulnerability assessment across all tech stacks.
...
const security_prefix = `${security_rules}

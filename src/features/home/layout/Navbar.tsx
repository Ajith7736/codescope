...
function Navbar() {
    ...
    return (
        <nav className='sticky top-0 z-20 backdrop-blur-xl bg-light-background/85 dark:bg-dark-background/60'>
            <Container className='min-h-[10vh] flex items-center justify-between'>
                ...
                <div className='flex gap-5 items-center text-lg'>
                    <Link href={"/Signup"} className='bg-light-surface px-4 py-1 cursor-pointer rounded-md hover:bg-light-surface-hover transition duration-300 dark:bg-dark-surface/20  dark:text-dark-text-primary text-light-text-primary hover:dark:text-dark-text-on-hover hover:text-light-text-on-hover dark:hover:bg-dark-surface-hover xss:text-[10px] lg:text-[12px]'>SignUp</Link>

        ...
        <nav className='sticky top-0 z-20 dark:bg-dark-background/80 bg-light-background/80  backdrop-blur-xl'>
            <Container className='min-h-[10vh] flex items-center justify-between'>
                ...
                <div className='flex gap-5 items-center text-lg'>
                    ...
                    <Link href={"/Pricing"} className='xss:text-[10px] lg:text-[12px] hover:text-light-text-on-hover transition-all duration-300 dark:hover:text-dark-text-on-hover text-light-text-primary dark:text-dark-text-primary'>Pricing</Link>

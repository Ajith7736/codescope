...
function Card({ logo, title, desc }: { logo: React.ReactElement, title: string, desc: string }) {
    return (
        <div className='bg-light-gray group flex flex-col gap-3 items-start p-5 dark:bg-dark-gray rounded-[17px]  w-full  md:w-[40%] border hover:border-light-accent/50 border-light-border transition-all duration-300 dark:border-dark-border'>

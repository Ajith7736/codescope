...
function MainTitle({ session }: { session: Session | null }) {
    ...
    return (
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }} className='relative z-10 flex flex-col gap-6 justify-center items-center pt-15 lg:px-50 xl:px-80 w-full h-full '>

...
export async function getUserData(req: any, res: any) {
  ...
  return (
    <div className='dark:bg-dark-surface shadow-lg m-5 bg-light-surface border xss:w-[20rem] sm:w-md xl:w-xl border-light-border dark:border-dark-border rounded-[7px]'>
      ...
      <div className='p-5 dark:bg-dark-background bg-light-background rounded-b-[7px]'>
        <pre className='text-[8px] md:text-xs dark:text-dark-text-muted text-black text-wrap'>{code}</pre>
      </div>
    </div>
  )
}

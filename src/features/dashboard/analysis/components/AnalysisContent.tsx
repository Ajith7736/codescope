  ...
  const Analysis: Analysiscontentprops[] = [
    {
      ...
      hover: "hover:bg-blue-500/30 text-blue-600",
      active: "bg-blue-500/30 text-blue-600",
      type: "Architecture"
    },
    {
      icon: <Shield className='size-4' />,
      hover: "hover:bg-pink-500/30 text-pink-600",
      active: "bg-pink-500/30 text-pink-600",
      type: "Security"
    }, {
      icon: <Zap className='size-4' />,
      hover: "hover:bg-green-500/30 text-green-600",
      active: "bg-green-500/30 text-green-600",
      type: "Performance"
    }
  ]

  return (
    <div className='h-screen bg-light-gray/50 overflow-auto flex flex-col items-center'>
      <div className='p-5 w-full border bg-light-white flex justify-between items-center border-light-activeborder/20 border-t-0 border-x-0'>
        <div>
          <SecondTitle>Ecommerce Application</SecondTitle>
          <div className='flex gap-2'>
            <SmallText textcolor='text-light-black/80'>47 files •</SmallText>
            <SmallText textcolor='text-light-black/80'>Last Analysed 2 hours ago</SmallText>
          </div>
        </div>
        <div>
      ...
      <div className='border m-5 xss:w-md md:w-xl xl:w-4xl border-light-activeborder/20 rounded-md'>

...
function MetaData() {
    ...
    return (
        <div className='bg-light-surface dark:bg-dark-surface border flex flex-col gap-3 xss:w-[70vw] md:w-[50vw] xl:w-[30vw] p-2 border-light-border dark:border-dark-border'>
            <p className='text-light-text-muted dark:text-dark-text-muted text-[10px] md:text-xs'>METADATA</p>

...
function RecentProject() {
    return (
        <div className='bg-dark-gray border lg:w-1/2 dark:border-dark-activeborder/20 rounded-md'>
            ...
            <div>
                <div className='p-8 hover:bg-dark-hovergray cursor-pointer'>
                    <div className='flex gap-4 items-center justify-between'>
                        <div className='flex gap-2'>
                            <div className='bg-blue-500 h-10 rounded-md w-10 flex items-center justify-center'><Code /></div>
                            <div>

...
function Card({ item }: { item: DashCardProps }) {
    return (
        <div className='dark:bg-dark-hovergray bg-light-gray border border-light-activeborder/20 flex flex-col p-7 xss:gap-3 md:gap-4 xss:w-[18rem] md:w-52  items-center rounded-md'>

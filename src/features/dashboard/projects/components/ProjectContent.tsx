  ...
  return (
    <div className='m-7 h-screen gap-3 flex flex-col items-center'>
      <div className='flex flex-col gap-3 items-center'>
        <input type="text" className='bg-light-gray border dark:bg-dark-inputfield border-light-activeborder/20 p-3 w-104 rounded-md focus:outline-none text-sm placeholder:text-sm' placeholder='Paste the Github Repo Link here' />

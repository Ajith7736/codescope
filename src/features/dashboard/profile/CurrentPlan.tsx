...
function CurrentPlan({ subscription }: {
    ...
    return (
        <div className=" xl:w-[75vw] w-full">
            ...
            <div className="bg-dark-accent/10 p-5 border border-dark-accent/20 rounded-[11px] xss:flex xss:flex-col xss:gap-3 lg:flex-row lg:justify-between lg:items-center">
